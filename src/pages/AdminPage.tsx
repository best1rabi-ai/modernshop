...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex" dir="rtl">
      ...
      {/* Sidebar */}
      <aside className="w-64 bg-gray-900 text-white min-h-screen hidden md:flex flex-col fixed rtl:right-0 ltr:left-0 z-20">
         ...
         <nav className="flex-1 p-4 space-y-2">
            ...
            <a href="#" className="flex items-center justify-between text-gray-300 hover:bg-gray-800 hover:text-white px-4 py-3 rounded-xl transition">
            ...
            <a href="#" className="flex items-center gap-3 text-gray-300 hover:bg-gray-800 hover:text-white px-4 py-3 rounded-xl transition">
               <Users className="w-5 h-5" /> ملفات الزبائن (CRM)
            </a>
            <a href="#" className="flex items-center gap-3 text-gray-300 hover:bg-gray-800 hover:text-white px-4 py-3 rounded-xl transition">
      ...
      <main className="flex-1 p-4 md:p-8 md:mr-64 overflow-x-hidden min-h-screen">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
             <div>
                <h1 className="text-3xl font-black text-gray-900">مرحباً، أيها المدير 👋</h1>
                <p className="text-gray-500 mt-1">إليك نظرة ذكية ومختصرة على حالة أعمالك اليوم.</p>
             </div>
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
             <div className="p-6 border-b border-gray-100 flex flex-wrap gap-4 justify-between items-center bg-gray-50/50">
                 ...
                 <div className="flex gap-2">
                     <button className="bg-white border border-gray-200 px-4 py-2 rounded-lg text-sm font-bold text-gray-700 hover:bg-gray-50 transition">الكل</button>
                     <button className="bg-blue-50 border border-blue-100 text-blue-700 px-4 py-2 rounded-lg text-sm font-bold transition">جديد</button>
                 </div>
             </div>
